export default function AboutPage() {
  return (
    <main className="about-page">
      ...
      <section className="about-story mt-5 pt-5">
        <div className="container">
          <div className="row" data-aos="fade-right">
            ...
            <div
              className="about-line d-flex justify-content-center align-items-center"
            >
              <span></span>
            </div>
          </div>
          <div className="row">
            <div className="story-timeline">
              <div className="story-indicators my-4">
                <div className="row">
                  <div data-aos="fade-right" className="image-box col-lg-2 px-0">
                    <img
                      className="w-100"
                      src="/assets/images/timeline-1.jpg"
                      alt=""
                    />
                    <div className="image-box-inner"><p className="mb-0">2000</p></div>
                  </div>
                  <div data-aos="fade-down" className="image-box col-lg-2 px-0">
                    <img
                      className="w-100"
                      src="/assets/images/timeline-2.jpg"
                      alt=""
                    />
                    <div className="image-box-inner"><p className="mb-0">2002</p></div>

                  </div>
                  <div data-aos="fade-up" className="image-box col-lg-2 px-0">
                    <img
                      className="w-100"
                      src="/assets/images/timeline-3.jpg"
                      alt=""
                    />
                    <div className="image-box-inner"><p className="mb-0">2004</p></div>
                  </div>
                  <div data-aos="fade-down" className="image-box col-lg-2 px-0">
                    <img
                      className="w-100"
                      ...
                      alt=""
                    />
                    <div className="image-box-inner"><p className="mb-0">2008</p></div>
                  ...
                  <div data-aos="fade-up" className="image-box col-lg-2 px-0">
                    <img
                      ...
                      alt=""
                    />
                    <div className="image-box-inner"><p className="mb-0">2012</p></div>

                  </div>
                  <div data-aos="fade-left" className="image-box col-lg-2 px-0">
                    <img
                      className="w-100"
                      src="/assets/images/timeline-6.jpg"
                      alt=""
                    />
                    <div className="image-box-inner"><p className="mb-0">2016</p></div>

                  </div>
                </div>
              </div>
              <div className="story-content py-5 my-4" data-aos="fade-right">
                <div>
                  <p className="text-center"><strong>16.10.2000:</strong>The Begin of Fooday Restaurents</p>
      ...
      <section className="testimonials py-2 my-2 mt-lg-4 pt-lg-4 mb-lg-0 pb-lg-0">
        <div className="container my-2 py-2 mt-lg-4 pt-lg-4 mb-lg-0 pb-lg-0">
          <div className="row">
            ...
            <div className="col-12 col-lg-8">
              <div className="testimonial-slider-wrapper">
                <div className="slider-content pt-5 pb-4 mx-4" data-aos="fade-down-left">
                  <div>
                ...
                <div className="slider-nav-wrapper mx-5" data-aos="fade-up-right">
      ...
      <section className="our-special my-5 py-5">
        <div className="container">
          <div className="row" data-aos="fade-right">
            <h2 className="text-center display-6 fw-bold">
              Our Special
            </h2>
            <div className="about-line d-flex justify-content-center align-items-center">
              <span></span>
            </div>
          </div>
          <div className="row justify-content-center">
            <div className="col-md-6 col-lg-4 mb-5 mb-lg-0">
              <div className="special-card" data-aos="fade-right">
                <div className="box-inner">
                  <div className="box-wrapper px-4">
                    <h2 className="pb-2">FRESH MENU</h2>
                    <p className="pb-4">Lorem ipsum dolor sit amet, consec adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
                    <div className="book-a-table">
                      <div className="anim-layer"></div>
                      <a href="#">Read More</a>
                    </div>
                  </div>
                  <div className="box-showcase pb-5">
                    <div className="d-flex flex-column align-items-center justify-content-center">
                      <img className="img-fluid" src="/assets/images/feature-box-bg.jpg" alt="" />
                      <h2 className="text-center">FRESH MENU</h2>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col-md-6 col-lg-4 mb-5 mb-lg-0">
              <div className="special-card" data-aos="flip-right">
                <div className="box-inner">
                  <div className="box-wrapper px-4">
                    <h2 className="pb-2">VARIOUS DRINK</h2>
                    <p className="pb-4">Lorem ipsum dolor sit amet, consec adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
                    <div className="book-a-table">
                      <div className="anim-layer"></div>
                      <a href="#">Read More</a>
                  ...
                  <div className="box-showcase pb-5">
                    <div className="d-flex flex-column align-items-center justify-content-center">
                      <img className="img-fluid" src="/assets/images/feature-box-bg-2.jpg" alt="" />
                      <h2 className="text-center">VARIOUS DRINK</h2>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="col-md-6 col-lg-4 mb-5 mb-lg-0">
              <div className="special-card" data-aos="fade-left">
                <div className="box-inner">
                  <div className="box-wrapper px-4">
                    <h2 className="pb-2">EXCLUSIVE DISHES</h2>
                    <p className="pb-4">Lorem ipsum dolor sit amet, consec adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
                    <div className="book-a-table">
                      <div className="anim-layer"></div>
                      <a href="#">Read More</a>
                  ...
                  <div className="box-showcase pb-5">
                    <div className="d-flex flex-column align-items-center justify-content-center">
                      <img className="img-fluid" src="/assets/images/feature-box-bg-3.jpg" alt="" />
                      <h2 className="text-center">EXCLUSIVE DISHES</h2>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="our-partner my-5">
        <div className="container partner-slider py-5" data-aos="fade-up-left">
          <div className="d-flex justify-content-center">
            <img className="img-fluid" src="/assets/images/partner-01.png" alt="" />
          </div>
          <div className="d-flex justify-content-center">
            <img className="img-fluid" src="/assets/images/partner-02.png" alt="" />
          </div>
          <div className="d-flex justify-content-center">
            <img className="img-fluid" src="/assets/images/partner-03.png" alt="" />
          </div>
          <div className="d-flex justify-content-center">
            <img className="img-fluid" src="/assets/images/partner-04.png" alt="" />
          </div>
          <div className="d-flex justify-content-center">
            <img className="img-fluid" src="/assets/images/partner-01.png" alt="" />
          </div>
